...
- `#772839` <span style="background-color: #772839; color: white; padding: 5px 10px; border-radius: 5px;">&nbsp;&nbsp;&nbsp;</span>

- `#4b262f` <span style="background-color: #4b262f; color: white; padding: 5px 10px; border-radius: 5px;">&nbsp;&nbsp;&nbsp;</span>

- `#1f1f1f` <span style="background-color: #1f1f1f; color: white; padding: 5px 10px; border-radius: 5px;">&nbsp;&nbsp;&nbsp;</span>

### Secundarios
- `#007cf1` <span style="background-color: #007cf1; color: black; padding: 5px 10px; border-radius: 5px;">&nbsp;&nbsp;&nbsp;</span>

- `#77b5d0` <span style="background-color: #77b5d0; color: white; padding: 5px 10px; border-radius: 5px;">&nbsp;&nbsp;&nbsp;</span>

- `#00f1ae` <span style="background-color: #00f1ae; color: white; padding: 5px 10px; border-radius: 5px;">&nbsp;&nbsp;&nbsp;</span>

- `#00f134` <span style="background-color: #00f134; color: white; padding: 5px 10px; border-radius: 5px;">&nbsp;&nbsp;&nbsp;</span>
