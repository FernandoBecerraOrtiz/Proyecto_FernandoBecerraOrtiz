...
CREATE TABLE users (
    ...
    tipo_usuario ENUM('estudiante', 'instructor', 'admin') NOT NULL,
    fecha_registro TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
	foto_perfil VARCHAR (255) NULL
);

-- Insertar usuarios con fechas aleatorias
INSERT INTO users (nombre, email, password, tipo_usuario, fecha_registro, foto_perfil) VALUES
...
('Pedro Santos Royano', 'pedro@gmail.com', '456', 'instructor', DATE_ADD('2024-01-01', INTERVAL RAND() * (DATEDIFF('2025-12-31', '2024-01-01')) DAY), 'person.svg'),
...
('Carlos Azaustre', 'carlosazaustre@gmail.com', '123', 'instructor', DATE_ADD('2024-01-01', INTERVAL RAND() * (DATEDIFF('2025-12-31', '2024-01-01')) DAY), 'images/team/carlosazaustre.png'),
('Carmen Ansio', 'carmenansio@gmail.com', '123', 'instructor', DATE_ADD('2024-01-01', INTERVAL RAND() * (DATEDIFF('2025-12-31', '2024-01-01')) DAY), 'images/team/carmenansio.png'),
('Carlos Santana Vega', 'dotcsv@gmail.com', '123', 'instructor', DATE_ADD('2024-01-01', INTERVAL RAND() * (DATEDIFF('2025-12-31', '2024-01-01')) DAY), 'images/team/dotcsv.png'),
('Miguel Ángel Durán', 'midudev@gmail.com', '123', 'instructor', DATE_ADD('2024-01-01', INTERVAL RAND() * (DATEDIFF('2025-12-31', '2024-01-01')) DAY), 'images/team/midudev.png'),
('Miriam González', 'miriamgonp@gmail.com', '123', 'instructor', DATE_ADD('2024-01-01', INTERVAL RAND() * (DATEDIFF('2025-12-31', '2024-01-01')) DAY), 'images/team/miriamgonp.png'),
('Brais Moure', 'mouredev@gmail.com', '123', 'instructor', DATE_ADD('2024-01-01', INTERVAL RAND() * (DATEDIFF('2025-12-31', '2024-01-01')) DAY), 'images/team/mouredev.png');
...
INSERT INTO courses (titulo, descripcion, instructor_id, precio, nivel, duracion, fecha_creacion, imagen_portada) VALUES
('Curso de Astro', 'Descubre cómo crear sitios web ultrarrápidos con Astro. Aprende a combinar componentes de diferentes frameworks, optimizar el rendimiento y desplegar proyectos eficientes.', 2, 29.99, 'intermedio', 10, DATE_ADD('2024-01-01', INTERVAL RAND() * (DATEDIFF('2025-12-31', '2024-01-01')) DAY), 'images/courses/astro.webp'),
('Curso de Tailwind', 'Domina Tailwind CSS, el framework de estilos más eficiente y moderno. Aprende a crear interfaces atractivas sin escribir CSS personalizado.', 2, 24.99, 'básico', 8, DATE_ADD('2024-01-01', INTERVAL RAND() * (DATEDIFF('2025-12-31', '2024-01-01')) DAY), 'images/courses/tailwind.webp'),
('Curso de Bootstrap', 'Aprende a construir sitios web totalmente responsivos con Bootstrap, el framework CSS más popular. Conoce su sistema de grid, componentes interactivos y personalización avanzada para crear proyectos visualmente atractivos en poco tiempo.', 2, 19.99, 'básico', 6, DATE_ADD('2024-01-01', INTERVAL RAND() * (DATEDIFF('2025-12-31', '2024-01-01')) DAY), 'images/courses/bootstrap.webp'),
('Curso de jQuery', 'Facilita la manipulación del DOM y la interacción con JavaScript mediante jQuery. Aprende a utilizar selectores, animaciones, eventos y peticiones AJAX para mejorar la experiencia del usuario en tus proyectos. Un curso dirigido a desarrolladores con conocimientos previos de JavaScript que desean optimizar su código.', 2, 14.99, 'intermedio', 7, DATE_ADD('2024-01-01', INTERVAL RAND() * (DATEDIFF('2025-12-31', '2024-01-01')) DAY), 'images/courses/jquery.webp'),
('Curso de JavaScript', 'Aprende JavaScript desde lo más básico hasta técnicas avanzadas, con buenas prácticas y ejemplos prácticos. Ideal para desarrolladores frontend.', 1, 49.99, 'intermedio', 30, DATE_ADD('2024-01-01', INTERVAL RAND() * (DATEDIFF('2025-12-31', '2024-01-01')) DAY), 'images/courses/javascript.webp'),
('Curso de Python', 'Aprende cómo aplicar técnicas de Machine Learning usando Python. Desde la teoría básica hasta la implementación de modelos complejos.', 3, 69.99, 'avanzado', 40, DATE_ADD('2024-01-01', INTERVAL RAND() * (DATEDIFF('2025-12-31', '2024-01-01')) DAY), 'images/courses/python.webp'),
('Curso de PHP', 'Este curso abarca el desarrollo backend con PHP, cubriendo desde la instalación de servidores locales hasta la creación de aplicaciones web interactivas.', 5, 39.99, 'intermedio', 30, DATE_ADD('2024-01-01', INTERVAL RAND() * (DATEDIFF('2025-12-31', '2024-01-01')) DAY), 'images/courses/php.webp');
...
('Desarrollo Web'), ('Programación'), ('Frontend'), ('Backend'), ('Bases de Datos'), ('DevOps'), ('JavaScript'), ('CSS'), ('PHP');
...
CREATE TABLE course_categories (
    ...
    curso_id INT,
    categoria_id INT,
    CONSTRAINT fk_course_category_curso FOREIGN KEY (curso_id) 
        REFERENCES courses(id) ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT fk_course_category_categoria FOREIGN KEY (categoria_id) 
        REFERENCES categories(id) ON DELETE SET NULL ON UPDATE CASCADE
);

-- Relacionar cursos con categorías (pertenecen a más de una categoría)
INSERT INTO course_categories (curso_id, categoria_id) VALUES
...
INSERT INTO lessons (curso_id, titulo, contenido, video_url, orden) VALUES
...
INSERT INTO progress (usuario_id, curso_id, leccion_id, completado, fecha_actualizacion) VALUES
(1, 1, 2, FLOOR(RAND() * 2), DATE_ADD('2024-01-01', INTERVAL RAND() * (DATEDIFF('2025-12-31', '2024-01-01')) DAY)), 
(1, 2, 3, FLOOR(RAND() * 2), DATE_ADD('2024-01-01', INTERVAL RAND() * (DATEDIFF('2025-12-31', '2024-01-01')) DAY)),
(1, 3, 5, FLOOR(RAND() * 2), DATE_ADD('2024-01-01', INTERVAL RAND() * (DATEDIFF('2025-12-31', '2024-01-01')) DAY)),
(1, 4, 1, FLOOR(RAND() * 2), DATE_ADD('2024-01-01', INTERVAL RAND() * (DATEDIFF('2025-12-31', '2024-01-01')) DAY)),
(1, 5, 4, FLOOR(RAND() * 2), DATE_ADD('2024-01-01', INTERVAL RAND() * (DATEDIFF('2025-12-31', '2024-01-01')) DAY)),
(1, 6, 2, FLOOR(RAND() * 2), DATE_ADD('2024-01-01', INTERVAL RAND() * (DATEDIFF('2025-12-31', '2024-01-01')) DAY)),
(1, 7, 3, FLOOR(RAND() * 2), DATE_ADD('2024-01-01', INTERVAL RAND() * (DATEDIFF('2025-12-31', '2024-01-01')) DAY));
...
-- Inscripción del estudiante en todos los cursos
...
BEGIN
    ...
    VALUES (NEW.id, 'INSERT', 'users', NEW.id, CONCAT('Nuevo usuario registrado: ', NEW.nombre), NOW());
END $$
...
BEGIN
    INSERT INTO auditoria (usuario_id, accion, tabla_afectada, registro_id, detalles, fecha_hora)
    VALUES (OLD.id, 'DELETE', 'users', OLD.id, CONCAT('Usuario eliminado: ', OLD.nombre), NOW());
END $$
...
BEGIN
    INSERT INTO auditoria (usuario_id, accion, tabla_afectada, registro_id, detalles, fecha_hora)
    VALUES (NEW.creado_por, 'INSERT', 'courses', NEW.id, CONCAT('Nuevo curso creado: ', NEW.nombre), NOW());
END $$
...
BEGIN
    INSERT INTO auditoria (usuario_id, accion, tabla_afectada, registro_id, detalles, fecha_hora)
    VALUES (OLD.creado_por, 'DELETE', 'courses', OLD.id, CONCAT('Curso eliminado: ', OLD.nombre), NOW());
END $$
...
BEGIN
    INSERT INTO auditoria (usuario_id, accion, tabla_afectada, registro_id, detalles, fecha_hora)
    VALUES (NEW.creado_por, 'INSERT', 'lessons', NEW.id, CONCAT('Nueva lección creada: ', NEW.nombre, ' en curso ', NEW.curso_id), NOW());
END $$
...
BEGIN
    INSERT INTO auditoria (usuario_id, accion, tabla_afectada, registro_id, detalles, fecha_hora)
    VALUES (OLD.creado_por, 'DELETE', 'lessons', OLD.id, CONCAT('Lección eliminada: ', OLD.nombre, ' del curso ', OLD.curso_id), NOW());
END $$
